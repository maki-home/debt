...
public class ConstraintViolationExceptionMessage {
	 ...
	 * {@link WebExchangeBindException} and {@link MessageSourceAccessor}.
	 *
	 * @param exception must not be {@literal null}.
	 * @param accessor must not be {@literal null}.
	 */
	public ConstraintViolationExceptionMessage(
			WebExchangeBindException exception, MessageSourceAccessor accessor) {

		Assert.notNull(exception,
				"RepositoryConstraintViolationException must not be null!");
